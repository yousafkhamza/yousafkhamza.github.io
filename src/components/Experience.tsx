...
const experiences = [
  {
    ...
    description: [
      "Architectured and automated AWS infrastructure for multi-region scalability, cost efficiency, and security compliance.",
      "Integrated SAST, DAST, and container security tools (OWASP ZAP, Burp Suite, Snyk, Trivy, Checkov, SonarQube) into DevSecOps pipelines, enabling automated security scanning, compliance checks, and reducing critical vulnerabilities by 90% before production release.",
      ...
      "Standardized Kubernetes deployment patterns using Helm/Kustomize for multi-environment application management, ensuring consistency and scalability across dev, stage, and prod clusters.",
      ...
      "Migrated legacy infrastructure by upgrading NGINX Plus (MyF5), Jenkins, and EKS versions, and led Solr search stack migration from on-premises to AWS-managed OpenSearch, improving scalability, performance, and reducing operational overhead.",
      "Used Argo CD for basic Kubernetes (EKS) deployment automation and GitOps-based application management across environments.",
    ],
  },
  {
    id: "quantiphi",
