    ...
    >
      ...
      <div className="container mx-auto relative z-10 flex flex-col items-center justify-center w-full">
        <AnimatedCard className="glass-card rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 max-w-4xl mx-auto text-center w-full">
          ...
          <p className="stagger-item stagger-delay-4 text-sm sm:text-base md:text-lg lg:text-xl text-foreground/80 max-w-4xl mx-auto mb-6 sm:mb-8 px-2">
            Architecting secure, highly available cloud platforms for fintech.<br />
            AWS, Terraform, Kubernetes, Docker, and CI/CD - end to end.<br />
