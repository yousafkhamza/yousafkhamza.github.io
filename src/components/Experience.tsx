...
const experiences = [
  {
    ...
    description: [
      " Architected and managed a secure, high-availability AWS ECS microservices infrastructure using Terraform ensuring seamless auto-scaling and resilience comparable to prior EKS setups.",
      " Enhanced cloud security posture by integrating Wazuh, AWS Config, and CloudWatch for real-time threat detection, compliance monitoring, and log analytics across fintech workloads.",
      " Built a real-time alerting system with AWS Lambda and Slack, automating notifications for critical GuardDuty and Wazuh events, cutting response time by 60%.",
      " Implemented least-privilege IAM models and fine-grained access controls across ECS, S3, and Lambda, improving audit readiness and minimizing the attack surface.",
      " Configured secure site-to-site VPN communication using OpenVPN between AWS and merchant networks, ensuring encrypted data transmission and stable interconnectivity for fintech transactions.",
      " Deployed PIM/PAM access controls for production Linux and Windows servers, improving privileged access governance and operational accountability.",
      " Embedded automated security scans (Trivy, Checkov, SonarQube) and compliance validation into CI/CD pipelines, accelerating secure deployments by 40%.",
      " Enforced compliance and governance aligned with fintech, SOC, and CBUAE regulatory standards through automated policy checks and audit reporting.",
      " Collaborated with Dev and Compliance teams to standardize secure deployment workflows and approval gates, ensuring fintech-grade governance across environments.",
    ],
  },
  {
    id: "alamy",
