...
const experiences = [
  {
    ...
    description: [
      ...
      " Optimized cost and performance using reusable Terraform modules integrated with VPC flow logs, centralized CloudTrail, and Prometheus monitoring, enhancing visibility and efficiency.",
